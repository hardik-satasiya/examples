...
export default (Base: React.ComponentClass<BaseListItemProps>) => class TodoItemController extends React.PureComponent<Props> {
  onCheckboxClick = () => {
  ...
  render() {
    ...
    return <Base {...rest} labelProps={{text: item.label}} completedCheckboxProps={{
