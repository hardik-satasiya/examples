...
export type AddItemInputEntered = {
} & Action<TodoAppActionType.ADD_ITEM_INPUT_ENTERED>;

export type AddItemButtonClicked = {
} & Action<TodoAppActionType.ADD_ITEM_BUTTON_CLICKED>;
...
export type ClearCompletedButtonClicked = {
} & Action<TodoAppActionType.CLEAR_COMPLETED_BUTTON_CLICKED>;

export type TodoAppAction = AddItemButtonClicked | AddItemInputEntered | ClearCompletedButtonClicked | AddItemInputChanged | ToggleItemClicked;
