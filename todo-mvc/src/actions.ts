...
export type TodoListCleareCompletedClicked = {

} & Action<ActionType.TODO_LIST_CLEAR_COMPLETED_CLICKED>;

export type TodoItemFilterButtonClicked = {
  filterType: TodoItemFilter;
} & Action<ActionType.TODO_ITEM_FILTER_BUTTON_CLICKED>;

export type TodoAppAction = TodoInputEntered | TodoItemCompleteCheckboxClicked | TodoListCleareCompletedClicked | TodoItemFilterButtonClicked;
...
export const todoItemCompleteCheckboxClicked = (item: TodoItem): TodoItemCompleteCheckboxClicked => ({
...
export const todoFilterItemButtonClicked = (filterType: TodoItemFilter): TodoItemFilterButtonClicked => ({
